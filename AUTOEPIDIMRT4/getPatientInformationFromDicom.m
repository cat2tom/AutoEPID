...
function [family_name,mrn,beam_name2,gantry_angle2,machine]=getPatientInformationFromDicom(epid_image_file)
...
family_name=[header.PatientName.FamilyName  ',  ' header.PatientName.GivenName];
