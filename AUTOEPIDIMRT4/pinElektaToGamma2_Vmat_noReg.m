...
% read TPS dose from Pinnacle TPS file.
 ...
 tpsdose=tpsdose*100; % changed to cGy from Gy.
...
%     thresh=2; % optimized value.
    ...
    % oonverted to fraction eg 10% to 0.1;
    thresh = thresh/100;
    dosetol = dosetol/100;
    %dta = dta/10;       % Convert to cm for new castle and Marks gamma.
...
[gmap2,npass2,gmean2,ncheck2] = GammaNoReg(image1,image2,xp,yp,dosetol2,dta2,thresh,rad_pix2);


% calculate gamma statisticsl
