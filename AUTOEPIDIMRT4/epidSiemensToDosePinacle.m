...
function epidSiemensToDosePinacle(epid_image_file)
...
%frames = double(char(header.Private_0039_1577));
frames=1;

if isfield(header,'Private_0039_1577')

frames=header.Private_0039_1577;

end 

if isfield(header,'Private_0039_1477')

frames=header.Private_0039_1477;
