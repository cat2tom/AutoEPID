...
m2=0.0001044300;
 [Ex,Ey,epiddose]=convertHisFileIntoImage3('Field_6.HIS',0.08322,0.0001047387);
...
%  imtool(epiddose)
 ...
 [xgrid,ygrid,tpsdose]=readPinnacleDose3('1176592_Beam_301-TotalDose.txt');
...
%    epid_inter=interp2(Ex,Ey,epiddose,xgrid,ygrid');
    ...
    epid_inter=interp2(xgrid,ygrid,tpsdose,Ex,Ey');
...
[output shiftedepid2] = dftregistration(fft2(epiddose),fft2(epid_inter),100);
...
%   [output shiftedepid] = dftregistration(fft2(epiddose),fft2(tps_inter),100);
  ...
  [output shiftedepid] = dftregistration(fft2(epiddose),fft2(shiftedepid3),100);
