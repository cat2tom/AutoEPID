function [GammaMap2, numpass, avg, numWithinField] = GammaNoReg(Image1, Image2, Xpoints, Ypoints, Dose_tol, DTA_tol, FE_thresh, rad)
...
[GammaMap, gammaAngle]=gamma2dnewandgammaangleNoReg(Reference,Evaluated,DTA,dosed,minLim,local );
