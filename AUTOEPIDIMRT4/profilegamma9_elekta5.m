...
mmtest=0.0001033087;
 [Ex,Ey,epiddose]=convertHisFileIntoImage3('Field_3.HIS',0.07298,m1);
...
%   
% shiftedepid3=imresize(shiftedepid3,[1024,1024]);
% 
% 
%  epid_inter2=interp2(Ex,Ey,shiftedepid3,xgrid,ygrid');
  
%   [output shiftedepid] = dftregistration(fft2(tpsdose),fft2(epid_inter2),100);
%   
%   [output shiftedepid] = dftregistration(fft2(epiddose),fft2(tps_inter),100);
...
%    
   ...
   dosetol=10;
    ...
    [gmap,npass,gmean,ncheck] = Gamma(image2,image1,xp,yp,dosetol,dta,thresh,rad_pix);
