function wr = wordreport5(varargin)
...
% ---------------------------------------
    ...
    function AddFigure(fnam1,fnam2)
        
%         hdlActiveX=actxserver('Word.Application');
%           Word_COM=hdlActiveX;
        
%           c=Word_COM.Documents;
...
%         
%         invoke(c,'Add');
        Pic = hdlActiveX.Selection.InlineShapes.AddPicture(fnam1);  

        set(Pic, 'ScaleHeight', 50, 'ScaleWidth', 50);
        hdlActiveX.Selection.MoveRight(1);
        hdlActiveX.Selection.TypeParagraph;
        Pic = hdlActiveX.Selection.InlineShapes.AddPicture(fnam2);  
        set(Pic, 'ScaleHeight', 50, 'ScaleWidth', 84.5);
        get(hdlActiveX.Selection.InlineShapes);
