function varargout = EImage(varargin)
% EIMAGE M-file for EImage.fig
%      EIMAGE produces an extended image window that provides easy-access
...
%
%      EImage processes all of the standard arguments of the Image function
...
%
%      [H1 H2 H3] = EImage returns handles to the main window elements for
...
%
%      EIMAGE('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in EIMAGE.M with the given input arguments.
%
%      EIMAGE('Property','Value',...) creates a new EIMAGE or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before EImage_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to EImage_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help EImage

% Last Modified by GUIDE v2.5 24-Nov-2011 11:24:47

% Begin initialization code - DO NOT EDIT
gui_Singleton = 0;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @EImage_OpeningFcn, ...
                   'gui_OutputFcn',  @EImage_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before EImage is made visible.
function EImage_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to EImage (see VARARGIN)

% Choose default command line output for EImage
...
% change handles to number as you can put handels and number in same array
% in new verion of matlab.

% main_axes=handles.main_axes;

test=handles.main_axes

class(test)

imageargs = [imageargs 'Parent' handles.main_axes];

% imageargs = [imageargs 'Parent' main_axes_num];
...
% UIWAIT makes EImage wait for user response (see UIRESUME)
% uiwait(handles.Eimage_fig);


% --- Outputs from this function are returned to the command line.
function varargout = EImage_OutputFcn(hObject, eventdata, handles) 
