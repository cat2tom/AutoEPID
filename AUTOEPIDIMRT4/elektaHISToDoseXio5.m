...
function elektaHISToDoseXio5(header, his_structure,pixel_to_dose_factor)
...
his_file_name=his_structure.file_name;
...
% only convert for M2 but not for m1
...
% rescaled the dose image
 ...
 dicomImageResize3(epid_dose_image_name);
 ...
 flipDicomUpDown(epid_dose_image_name);
