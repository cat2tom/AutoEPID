...
function InsertImage(varargin)
        
        % insert image such as jpgs for one page
        % written and added by Aitang
        inArgs(1:nargin)=varargin;
        fnam1=inArgs(1);
        fnam2=inArgs(2);
       
        Pic=hdlActiveX.ActiveDocument.Selection.InlineShapes.AddPicture(fnam1);
%         s=hdlActiveX.Selection.InlineShapes; 
%         invoke(s,'addpicture',fnam1);
        set(Pic, 'ScaleHeight', 50, 'ScaleWidth', 50);
        hdlActiveX.ActiveDocument.Selection.MoveRight(1);
        hdlActiveX.ActiveDocument.Selection.TypeParagraph;
        
              
       
        Pic=hdlActiveX.ActiveDocument.Selection.InlineShapes.AddPicture(fnam2);  
