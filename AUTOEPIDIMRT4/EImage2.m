...
switch buttonpushed
    ...
    case 'summary_togglebutton'
        ...
        summarystring = CalculateSummaryData(idata);
...
function summarystring = CalculateSummaryData(imagedata,xvalues,yvalues)
...
summarystring = {'Image Summary'; ['Minimum Value: ' num2str(minimage)]; ...
