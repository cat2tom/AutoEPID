function [gamma_result_file_name,numpass3b,avg3b,numpass2b,avg2b,beam_name2]=pinElektaToGamma2_manual(pin_tps_file, epid_his_file,DTA,tol,PSF,pixel_dose_factor,coll_angle)
...
%     
	...
	radius_cm2 = dta2/10*3;% changed radius to 3 times of dta
...
%     dta=dta*10/1.5;
    res_x = xp(20) - xp(19);
    res_y = yp(20) - yp(19);
    radius_cm = dta/10*3;% changed to 3 times of DTA.
    thresh = thresh/100;
    dosetol = dosetol/100;
...
% 
% % critical_val3=0.1*max(gmap(:)); % applied threshold. changed from 10 to 5%
% critical_val3=0;
