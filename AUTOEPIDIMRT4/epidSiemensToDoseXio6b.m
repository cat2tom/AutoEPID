...
function [xgrid_epid,ygrid_epid,epiddose]=epidSiemensToDoseXio6(epid_image_file,pixel_to_dose_factor)
...
ypos=position(2);
xgrid_epid=(xpos:res(1):-xpos);

ygrid_epid=(-ypos:res(2):ypos);
...
% 
% xgrid_epid=xgrid_epid2(1:end-1);
% 
% ygrid_epid=ygrid_epid2(1:end-1);
