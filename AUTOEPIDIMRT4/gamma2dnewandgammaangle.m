function [G, gammaAngle ] = gamma2dnewandgammaangle ( Reference, Evaluated ,DTA, dosed , minLim , localorglobal )
...
% minLim = minLim*max( Reference ( : ) ) ;
 ...
 searchRange = round(2*DTA+1) ; % changed to 2 times of DTA to match OminiPro.
