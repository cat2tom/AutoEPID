function profile_image_file_name=pinElektaToProfile2_noReg(pin_tps_file, epid_his_file,PSF,DTA,tol,pixel_dose_factor,coll_angle)

%{
This function was added for commissioning purpose by bypassing the
registration. 
%}
