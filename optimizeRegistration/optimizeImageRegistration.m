function [shifted_tar_image,opt_x_shift,opt_y_shift] = optimizeImageRegistration(ref_image,tar_image )
...
opt_x_shift=optimizeProfileShift(ref_xx_cor,ref_xy_cor,ref_x_pixel,tar_x_pixel) ;

opt_y_shift=optimizeProfileShift(ref_yx_cor,ref_yy_cor,ref_y_pixel,tar_y_pixel) ;
