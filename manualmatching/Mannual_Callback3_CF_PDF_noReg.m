...
function handles=Mannual_Callback3_CF_PDF_noReg(hObject,handles)
...
%                  [gamma_image_file_name,profile_image_file_name,npass,gmean,npass2,gmean2,beam_name2]=profileGammaAnalysisSiemensPin2(tps_file,epid_dicom_file,DTA,tol, dose_factor,coll_angle);
                 ...
                 [gamma_image_file_name,profile_image_file_name,npass,gmean,npass2,gmean2,beam_name2]=profileGammaAnalysisSiemensPin2_noReg(tps_file,epid_dicom_file,DTA,tol, dose_factor,coll_angle);
                ...
                if strcmp(treatment_type,'VMAT')
                    ...
                    [gamma_image_file_name,profile_image_file_name,beam_name2]=profileGammaAnalysisSiemensPin2_Vmat_noReg(tps_file,epid_dicom_file,DTA,tol, dose_factor);
          ...
          if strcmp(tps,'Pinnacle')
              ...
              if strcmp( handles.output_option, 'EPID Dose Image+AutoReport')
                ...
                if strcmp(treatment_type,'IMRT')  
                   ...
                   [gamma_image_file_name,profile_image_file_name,npass,gmean,npass2,gmean2,beam_name2]=profileGammaAnalysisElektaPin2_noReg_manual(tps_file,epid_his_file,DTA,tol,PSF,pixel_dose_factor,coll_angle);
                     
                  
                   
                   
                    % disable image dose conversion.					 
                ...
                if strcmp(treatment_type,'VMAT')  
                     ...
                     [gamma_image_file_name,profile_image_file_name,numpass3,avg3,numpass2,avg2]=profileGammaAnalysisElektaPin2_Vmat_noReg(tps_file,epid_his_file,DTA,tol,PSF,pixel_dose_factor);                
                     ...
                     gmean2=avg2;
                      ...
                      % disable epid image dose conversi0n
