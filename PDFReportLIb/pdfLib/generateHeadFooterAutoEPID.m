function  generateHeadFooterAutoEPID( writer,cb,f_cb,width,height,BaseColor,version_info )
...
%   Detailed explanation goes here
 ...
 head_txt='LCTC & MCTC IMRT/VMAT Patient QA Report';
 
 cb.setTextMatrix(width/2-200,height-30);% left and top (x,y) is the position where to write the text. 
...
%  footer2='AutoEPID V3.0';
 
 footer2=version_info;
