...
function epidSiemensToDoseXio5(epid_image_file,pixel_to_dose_factor)
...
epid_dose_name=['Gantry ' gantry_angle2 '_Patient ' family_name '_MRN ' mrn '_' machine '_EPID dose' '.dcm'];
