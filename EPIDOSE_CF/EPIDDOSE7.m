...
dir_path=uigetdir(current_dir,'Choose a directory where the EPID images sit '); % ask user to select directory
...
copyfile(dir_path,h_driver_patient_dir);
